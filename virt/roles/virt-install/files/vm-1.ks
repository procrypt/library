...
# network
#network --bootproto static --device eth0 --gateway 192.168.122.254 --ip 192.168.122.2 --netmask 255.255.255.0 
network --bootproto=static --ip=192.168.122.10 --netmask=255.255.255.0 --gateway=192.168.122.1 --device=eth0 --noipv6 --activate --hostname=master --nameserver=8.8.8.8,8.8.4.4
