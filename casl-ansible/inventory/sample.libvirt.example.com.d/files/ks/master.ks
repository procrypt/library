...
# network
network --bootproto=static --ip=192.168.122.10 --netmask=255.255.255.0 --gateway=192.168.122.1 --device=eth0 --noipv6 --activate --hostname=master --nameserver=192.168.122.1
